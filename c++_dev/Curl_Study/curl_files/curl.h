...
#define CURLOPT_SERVER_RESPONSE_TIMEOUT CURLOPT_FTP_RESPONSE_TIMEOUT
  ...
  */
  ...
  CURLOPT(CURLOPT_QNX_PROXYINFO, CURLOPTTYPE_LONG, 10000),
  CURLOPT(CURLOPT_PPS_ROOT, CURLOPTTYPE_OBJECTPOINT, 10001),
  ...
  CURLOPT(CURLOPT_QNX_AKAV1MD5_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 9000),
  CURLOPT(CURLOPT_QNX_AKAV1MD5_DATA, CURLOPTTYPE_OBJECTPOINT,   9001),

  CURLOPT(CURLOPT_QNX_CREDMGR_HANDLE, CURLOPTTYPE_OBJECTPOINT, 9002),
  CURLOPT(CURLOPT_QNX_PROXY_CREDMGR_HANDLE, CURLOPTTYPE_OBJECTPOINT, 9003),
  ...
  /* Negotiate should generate its ticket using a host's canonical name. These
     ...
     not canonical. */
  CURLOPT(CURLOPT_QNX_NEGOTIATE_CNAME, CURLOPTTYPE_OBJECTPOINT, 9004),
  CURLOPT(CURLOPT_QNX_PROXY_NEGOTIATE_CNAME, CURLOPTTYPE_OBJECTPOINT, 9005),
  ...
  /* Set a function that is called when creating an SSL connection, right after
     ...
     SSL_CTX*. */
  CURLOPT(CURLOPT_QNX_SSL_NEW_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 9006),

  /* Set the userdata for the ssl new callback function's third argument. */
  CURLOPT(CURLOPT_QNX_SSL_NEW_DATA, CURLOPTTYPE_OBJECTPOINT, 9007),
#endif
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/io-pkt/dist/curl/include/curl/curl.h $ $Rev: 950799 $")
#endif
